import { B as rotate, Ct as isEmpty, D as toUserCoordinate, U as wrapX, V as scale, W as warn, bt as getWidth, g as fromUserCoordinate, gt as getIntersection, it as equals, mt as getForViewAndSize, q as clone, tt as createOrUpdateEmpty } from "./proj-C8Vwf-re.js";
import { n as clamp } from "./math-7aBOSnLj.js";
import { t as clear } from "./obj-BGAAjjDC.js";
import { t as hasArea } from "./size-Bir6Ad0C.js";
import { a as VOID, c as Disposable, f as unlistenByKey, i as TRUE, l as EventType_default$1, m as getUid, n as BaseEvent, p as abstract, r as FALSE, s as toPromise, t as Target, u as listen, v as equals$1 } from "./Target-D_UbYRbx.js";
import { i as assert, r as ObjectEventType_default, t as BaseObject } from "./Object-jqh05rKX.js";
import { a as fromString, n as compose, o as makeInverse, r as create, t as apply } from "./transform-CzugI82s.js";
import { c as replaceNode, d as DEVICE_PIXEL_RATIO, h as WORKER_OFFSCREEN_CANVAS, i as isCanvas, n as createMockDiv, o as removeChildren, p as PASSIVE_EVENT_LISTENERS, s as replaceChildren } from "./dom-tymdwjil.js";
import { t as TileState_default } from "./TileState--OC5z7qU.js";
import { n as easeOut } from "./easing-BXmlmOaZ.js";
import { n as CollectionEventType_default, t as Collection } from "./Collection-CErL1OcC.js";
import { _ as zoomByDelta, a as always, b as MapBrowserEvent, c as mouseOnly, d as platformModifierKey, f as primaryAction, g as pan, h as Interaction, i as altShiftKeysOnly, m as targetNotEditable, n as centroid, o as focusWithTabindex, p as shiftKeyOnly, r as all, s as mouseActionButton, t as PointerInteraction, u as noModifierKeys, x as MapEvent, y as MapBrowserEventType_default } from "./Pointer-D-Cgy6Gq.js";
import { d as disable, f as ViewHint_default, t as View } from "./View-piMLe0gh.js";
import { t as Polygon } from "./Polygon-CzzttF1o.js";
import { C as CLASS_COLLAPSED, E as CLASS_UNSELECTABLE, T as CLASS_HIDDEN, c as checkedFonts, w as CLASS_CONTROL } from "./Style-DGkPryMp.js";
import { a as BaseLayer, i as EventType_default$2, n as Layer, r as inView, t as RenderEvent } from "./Event-B68AYbh4.js";
import { t as BaseVectorLayer } from "./BaseVector-Be4DzqeO.js";
import { i as shared } from "./Fill-CakkyiKb.js";
...
var Attribution = class extends Control {
	...
	*/
	async updateElement_(frameState) {
		...
		if (equals$1(attributions, this.renderedAttributions_)) return;
 ...
 /**
	...
	renderFrame_(time) {
		...
		if (frameState) {
			...
			if (previousFrameState) {
				if (!this.previousExtent_ || !isEmpty(this.previousExtent_) && !equals(frameState.extent, this.previousExtent_)) {
					this.dispatchEvent(new MapEvent(MapEventType_default.MOVESTART, this, previousFrameState));
					this.previousExtent_ = createOrUpdateEmpty(this.previousExtent_);
				}
			}
			if (this.previousExtent_ && !frameState.viewHints[ViewHint_default.ANIMATING] && !frameState.viewHints[ViewHint_default.INTERACTING] && !equals(frameState.extent, this.previousExtent_)) {
	...
	*/
	updateSize() {
		...
		if (size && (!oldSize || !equals$1(size, oldSize))) {
