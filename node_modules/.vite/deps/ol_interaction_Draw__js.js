import { n as clamp, s as squaredDistance, u as toFixed } from "./math-7aBOSnLj.js";
import { _ as EventType_default, b as unlistenByKey, i as TRUE, n as BaseEvent, r as FALSE, v as listen } from "./Target-yyngc7-i.js";
import { r as createEditingStyle } from "./Style-BjWyFNyH.js";
import { a as always, b as MapBrowserEvent, l as never, p as shiftKeyOnly, t as PointerInteraction, u as noModifierKeys, v as Property_default, y as MapBrowserEventType_default } from "./Pointer-CZaBKTW8.js";
import { C as getUserProjection, G as boundingExtent, J as closestSquaredDistanceXY, U as squaredDistance$1, at as extend, ct as forEachCorner, dt as getBottomRight, et as createOrUpdate, ft as getCenter, g as fromUserCoordinate, tt as createOrUpdateEmpty, ut as getBottomLeft, vt as getTopLeft, xt as intersects, yt as getTopRight, z as distance } from "./proj-WMMAY-sr.js";
import { A as SimpleGeometry, N as Geometry, P as rotate, i as makeRegular, j as getStrideForLayout, n as fromCircle, t as Polygon, u as Point, y as deflateCoordinate } from "./Polygon-DmGnCC58.js";
import { a as MultiLineString, i as MultiPoint, o as LineString, r as MultiPolygon, s as Feature, t as VectorSource } from "./Vector-DDnqp8eA.js";
import { t as VectorLayer } from "./Vector-hhZrXaUe.js";
...
function createRegularPolygon(sides, angle) {
	return function(coordinates, geometry, projection) {
		...
		const radius = Math.sqrt(squaredDistance$1(center, end));
