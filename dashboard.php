		  ...
		  <div id="modal-form"> 
			  <form id="declare_form">
				  <table>
					...
					<tr>
						<td> 
							Please check the exact Max Altitude on <a href="https://www.geoportail.gouv.fr/carte" target="_blank">Geoportail</a> or other profesionnal map systeme and fill it here in Meters (AMSL).
						</td>
						<td>
